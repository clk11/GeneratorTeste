...
public class LollipopCheckBox : CheckBox
{
    ...
    {
        Height = 22;
        Width = 20 + (int)CreateGraphics().MeasureString(Text, font.Roboto_Medium15).Width;
    }
    ...
    protected override void OnPaint(PaintEventArgs pevent)
    {
        ...
        //CheckBox Text    
        g.DrawString(Text, font.Roboto_Medium15, new SolidBrush(Enabled ? EnabledStringColor : DisabledStringColor), 21, -3);
    }
